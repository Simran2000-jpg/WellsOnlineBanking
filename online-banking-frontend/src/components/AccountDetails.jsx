      ...
      <div className="form-container mt-5 margin-left-sidebar">
        ...
        <div className="container">
          <div className="row">
              ...
              <div>
                ...
                {!selectedAccount.transactionPassword && (
                  <div className="form-container d-flex flex-column align-items-between h-40">
                    <p className="text-start h6">Not yet Done</p>
                    <NavLink
                      to={`/dashboard/internet-banking/${selectedAccount.accountNo}`}
            ...
            <div className="col-4 ">
              <div
                className="w-30 h-100 bg-light p-4 d-flex flex-column"
            ...
            <div className=" col-4 flex-column d-flex justify-content-evenly">
              <div className="form-container d-flex flex-column align-items-between h-40">
                <p className="text-start h6">Choose your Account</p>
                <select
