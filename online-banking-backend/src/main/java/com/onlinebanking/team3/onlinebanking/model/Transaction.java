...
public class Transaction {
    ...
    @ManyToOne
    @JoinColumn(foreignKey = @ForeignKey(name = "to_beneficiary_id"), name = "to_beneficiary_id")
    private Beneficiary toBeneficiary;

    @ManyToOne
    @JoinColumn(foreignKey = @ForeignKey(name = "from_account_id"), name = "from_account_id")
